  ...
  return (
    <>
      ...
      <div className="horizontal-line slide-to-top">
        <span className="white-shadow-effect">
          WELCOME TO{" "}
          <span className="second-main-color-text white-shadow-effect">
            PLAIT
          </span>{" "}
        </span>
      </div>
      <div className="frame slide-to-top">
        <span className="quote-sentence">
          An information technology learning platform that connects students and
          businesses for growth.
        </span>
        <span className="quote-sentence">
          We are committed to providing high-quality courses that enhance skills
          and knowledge in the IT field.
        </span>
      </div>
        ...
        <div className="group-container">
          <div className="group">
            ...
            <span className="group-content">
              Discover a wide range of IT courses, from beginner to advanced
              levels, designed to cater to all skill sets.
            </span>
            <span className="group-content">
              Whether you are just starting your journey in technology or
              looking to deepen your expertise, sign up today to join courses
              that align with your interests and learning goals.
            </span>
          </div>
          ...
          <div className="group">
            ...
            <span className="group-content">
              Sign up to create paid courses and enroll qualified instructors to
              deliver high-quality instruction.
            </span>
            <span className="group-content">
              This initiative offers staff the opportunity to enhance their
              skills and stay up-to-date with the latest technologies through
              comprehensive and well-structured training programs.
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="feature-card-container">
          <div className="feature-card">
            ...
            <span className="feature-card-content">
              Videos, texts, and exercises to enhance the learning experience.
            </span>
          </div>
          ...
          <div className="feature-card">
            ...
            <span className="feature-card-content">
              Learn anytime and anywhere on your mobile device, giving you
              convenient access to educational resources and courses.
            </span>
          </div>
          ...
          <div className="feature-card">
            ...
            <span className="feature-card-content">
              Chat and comment to interact and share knowledge with your
              instructors.
            </span>
          </div>
        </div>
