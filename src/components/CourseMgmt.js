...
const CourseMgmt = (props) => {
    ...
    currentItemsPage = currentCourses.slice(currentPage * itemsPerPage - itemsPerPage, currentPage * itemsPerPage);
                    ...
                    <div className="main-box">
                        <div className="field">
                            ...
                            <select
                                ...
                                onChange={(e) => setSortConditionCourse({ ...sortConditionCourse, field: e.target.value })}
                            >
                            ...
                            <select
                                className="select-sortby"
                                onChange={(e) => setSortConditionCourse({ ...sortConditionCourse, direction: e.target.value })}
                            >
